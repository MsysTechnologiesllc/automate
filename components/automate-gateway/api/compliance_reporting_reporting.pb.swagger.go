  ...
  "paths": {
    "/compliance/reporting/controls": {
      "post": {
        ...
        "description": "List all controls optionally using filters. This is some more text to see how much stuff\nsurvives proto compilation.\n\nHere is more text. This is yet more text.\n\nHere is some markdown:\n\n# Table\n| Syntax | Description |\n| --- | --- |\n| Header | Title |\n| Paragraph | Text |\n\n# List\n\n1. First item\n2. Second item\n3. Third item\n\n- First item\n- Second item\n- Third item\n\n# Code block\n\n` + "`" + `` + "`" + `` + "`" + `\n{\n\"firstName\": \"John\",\n\"lastName\": \"Smith\",\n\"age\": 25\n}\n` + "`" + `` + "`" + `` + "`" + `",
